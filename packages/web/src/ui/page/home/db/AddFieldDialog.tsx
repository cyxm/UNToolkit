...
import { useDbStore, Field, FieldType, FieldEditorStartParam } from '@/store/dbStore';
...
export default function AddFieldDialog({
  ...
  const { templateFields, initTemplateFields } = useDbStore();
